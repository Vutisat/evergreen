...
public class MainActivity extends Activity {
	...
	//	this.refreshNotification();
		...
		ArrayAdapter<String> cbAdapter = (ArrayAdapter<String>) ((ListView) findViewById(R.id.clipboardListView))
				.getAdapter();
...
//	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// draw initial notification -- this is placed after we retrieve values
		// so the # displayed is correct
		//this.refreshNotification();
		
		
		Log.d("MainActivity", "RUNNIN!");
	...
	private void retrieveStoredClippings() {
		...
		HashSet<String> retrievalSet = (HashSet<String>) sPreferences
				.getStringSet("clipboardData", new HashSet<String>());
